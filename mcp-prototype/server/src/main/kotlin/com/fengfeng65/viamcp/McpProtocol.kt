...
/**
 * Minimal protocol model for the Via MCP prototype.
 * Transport is intentionally kept separate from the browser bridge so the
 * implementation can move from local loopback testing to authenticated HTTP.
 */
